                        ...
                        <div id="additionalFields" style="display: none;">
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <select name="category_fonctionnaire_id" id="category_fonctionnaire_id" class="form-control" required>
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>"><?php echo e($category->nomFr); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <select name="id_matricule" id="id_matricule" class="form-control" required>
                                    ...
                                    <?php $__currentLoopData = $matricules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $matricule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($matricule->id); ?>"><?php echo e($matricule->numero); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <select name="id_grade" id="id_grade" class="form-control" required>
                                    ...
                                    <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($grade->id); ?>"><?php echo e($grade->nomFr); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <select name="id_service" id="id_service" class="form-control" required>
                                    ...
                                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($service->id); ?>"><?php echo e($service->nomFr); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <select name="id_status" id="id_status" class="form-control" required>
                                    ...
                                    <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($stat->id); ?>"><?php echo e($stat->status_fonctionnaire); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Application_RH_v17_08_vf\Application_RH_v26_07\resources\views/RH/users/create.blade.php ENDPATH**/ ?>