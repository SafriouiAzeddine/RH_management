<?php if(auth()->user()->role == '1'): ?> <!-- Assuming '1' represents admin RH role -->

<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
  <div class="sidenav-header">
    <i class="fas fa-times p-3 cursor-pointer text-white opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
    <a class="navbar-brand m-0" href="#">
      <img src="<?php echo e(asset('upload_files/logo_app/logo.png')); ?>" >
  ...
  <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link text-white active bg-gradient-primary" href="<?php echo e(route('admin.dashboardadmin')); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="<?php echo e(route('listdemandes.index')); ?>">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="submenuUsers">
          <ul class="nav nav-sm flex-column">
            <li class="nav-item">
              <a class="nav-link text-white" href="<?php echo e(route('users.create')); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="<?php echo e(route('notifications.index')); ?>">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="submenuChat">
          <ul class="nav nav-sm flex-column">
            <li class="nav-item">
              <a class="nav-link text-white" href="<?php echo e(route('conversations.index')); ?>">
                <i class="material-icons me-2">lock</i> Discussion Privé
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white" href="<?php echo e(route('message.index')); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="<?php echo e(route('division.index')); ?>">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="<?php echo e(route('service.index')); ?>">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="<?php echo e(route('profileadmin.index')); ?>">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<?php elseif(auth()->user()->role == '0'): ?> <!-- Assuming '0' represents fonctionnaire role -->
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
  <div class="sidenav-header">
    <i class="fas fa-times p-3 cursor-pointer text-white opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
    <a class="navbar-brand m-0" href="#">
  ...
  <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link text-white active bg-gradient-primary" href="<?php echo e(route('fonctionnaire.dashboard')); ?>">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">dashboard</i>
          </div>
          <span class="nav-link-text ms-1">Dashboard</span>
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="submenuDemandes">
          <ul class="nav nav-sm flex-column">
            <li class="nav-item">
              <a class="nav-link text-white" href="<?php echo e(route('demandes.create')); ?>">
                <i class="material-icons me-2">note_add</i> Ajouter Demande
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white" href="<?php echo e(route('demandes.index')); ?>">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="submenuChat">
          <ul class="nav nav-sm flex-column">
            <li class="nav-item">
              <a class="nav-link text-white" href="<?php echo e(route('fonctionnaire.conversations.show')); ?>">
                <i class="material-icons me-2">lock</i> Discussion Privé
              </a>
            </li>
            <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="<?php echo e(route('profile.index')); ?>">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">person</i>
          </div>
          <span class="nav-link-text ms-1">Profile</span>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Application_RH_v17_08_vf\Application_RH_v26_07\resources\views/Layouts/imc/sidebar.blade.php ENDPATH**/ ?>