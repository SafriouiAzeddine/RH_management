<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
    <div class="container-fluid py-1 px-3 ">
        <?php if(Breadcrumbs::exists()): ?>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <?php $__currentLoopData = Breadcrumbs::generate(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breadcrumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <ul class="navbar-nav justify-content-end">
          ...
          <li class="nav-item dropdown pe-2 d-flex align-items-center me-3">
            <a href="javascript:;" class="nav-link text-body p-0 position-relative" id="dropdownMenuButtonDemands" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <span class="badge badge-warning notification-count" id="notificationCountDemands"><?php echo e(auth()->user()->unreadNotifications->whereIn('type', ['App\Notifications\DemandeStatusConfirmation', 'App\Notifications\DemandeCreated'])->count()); ?></span>
            </a>
            <ul class="dropdown-menu scrollable-menu dropdown-menu-end px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButtonDemands" id="notificationListDemands">
                <?php $__currentLoopData = auth()->user()->unreadNotifications->whereIn('type', ['App\Notifications\DemandeStatusConfirmation', 'App\Notifications\DemandeCreated']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li class="mb-2 notification-item" data-id="<?php echo e($notification->id); ?>" data-type="demand">
                      <a class="dropdown-item border-radius-md" href="<?php echo e(route('notifications.show', $notification->id)); ?>">
                              ...
                              <div class="my-auto">
                               ...
                               <!-- Check if the notification has a status (indicating it's a response from the admin) -->
                                <?php if(isset($notification->data['status'])): ?>
                                    ...
                                    <img src="<?php echo e(asset('upload_files/photos/admin.png')); ?>" class="avatar avatar-sm me-3"> <!-- Default admin image -->
                                <?php else: ?>
                                    <!-- If there's no status, it means the notification is from the user -->
                                    <?php if(isset($notification->data['photo'])): ?>
                                        <img src="<?php echo e(asset('upload_files/photos/' . $notification->data['photo'])); ?>" class="avatar avatar-sm me-3">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('upload_files/photos/default.png')); ?>" class="avatar avatar-sm me-3"> <!-- Default user image -->
                                    <?php endif; ?>
                                <?php endif; ?>
          ...
          <li class="nav-item dropdown pe-2 d-flex align-items-center">
            <a href="javascript:;" class="nav-link text-body p-0 position-relative" id="dropdownMenuButtonMessages" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <span class="badge badge-warning notification-count" id="notificationCountMessages"><?php echo e(auth()->user()->unreadNotifications->where('type', 'App\Notifications\NewMessageNotification')->count()); ?></span>
            </a>
            <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4 scrollable-menu" aria-labelledby="dropdownMenuButtonMessages" id="notificationListMessages">
              <?php $__currentLoopData = auth()->user()->unreadNotifications->where('type', 'App\Notifications\NewMessageNotification'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li class="mb-2 notification-item" data-id="<?php echo e($notification->id); ?>" data-type="message">
                      <a class="dropdown-item border-radius-md" href="<?php echo e(route('notifications.redirect', $notification->id)); ?>">
                          <div class="d-flex py-1">
                              <div class="my-auto">
                                <?php if(isset($notification->data['photo'])): ?>
                                    <img src="<?php echo e(asset('upload_files/photos/' . $notification->data['photo'])); ?>" class="avatar avatar-sm me-3">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('upload_files/photos/admin.png')); ?>" class="avatar avatar-sm me-3"> <!-- Default image -->
                                <?php endif; ?>
                              </div>
                              <div class="d-flex flex-column justify-content-center">
                                  <h6 class="text-sm font-weight-normal mb-1">
                                    Nouveau message de <?php echo e($notification->data['sender']); ?>
          ...
          <li class="nav-item dropdown pe-2 d-flex align-items-center">
            <a href="javascript:;" class="nav-link text-body p-0 position-relative" id="dropdownMenuButtonPublicMessages" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <span class="badge badge-warning notification-count" id="notificationCountPublicMessages"><?php echo e(auth()->user()->unreadNotifications->where('type', 'App\Notifications\NewNotificationPublic')->count()); ?></span>
            </a>
            <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4 scrollable-menu" aria-labelledby="dropdownMenuButtonPublicMessages" id="notificationListPublicMessages">
              <?php $__currentLoopData = auth()->user()->unreadNotifications->where('type', 'App\Notifications\NewNotificationPublic'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li class="mb-2 notification-item" data-id="<?php echo e($notification->id); ?>" data-type="public_message">
                      <a class="dropdown-item border-radius-md" href="<?php echo e(route('notifications.redirect', $notification->id)); ?>">
                          <div class="d-flex py-1">
                              <div class="my-auto">
                                <?php if(isset($notification->data['photo'])): ?>
                              ...
                              <div class="d-flex flex-column justify-content-center">
                                  <h6 class="text-sm font-weight-normal mb-1">
                                    Nouveau message public de <?php echo e($notification->data['sender']); ?>
          ...
          <li class="nav-item d-flex align-items-center">
            <a class="nav-link text-body font-weight-bold px-0" href="<?php echo e(route('logout')); ?>"
  ...
  <script>
    ...
    </script><?php /**PATH C:\xampp\htdocs\Application_RH_v17_08_vf\Application_RH_v26_07\resources\views/Layouts/imc/navbar.blade.php ENDPATH**/ ?>